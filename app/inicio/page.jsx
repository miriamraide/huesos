      ...
      <div className="flex justify-evenly items-center">
        <div className="box text-lg text-center pb-6 sm:pb-0  bg-yellow-400">
          ...
          <div className="text-xl text-center pb-6 sm:pb-0 text-gray-700  font-bold mx-5 my-5">
            ...
            primera calidad, desarrollados en granjas locales con materia prima
            puramente orgánica. Alimentos balanceados, controlados por
            ...
            lo mejor. Los precios son muy razonables. En Barkery, nos esforzamos
            en que la calidad no impacte altamente en los precios. Cuidamos tus
            mascotas y tu presupuesto. <br /> <br />
        ...
        <div className=" bg-yellow-400 box text-xl text-center pb-6 sm:pb-0 text-gray-700  font-bold mx-5 my-5">
          <div>
            ...
            contribución positiva al bienestar del planeta. <b>BARKery</b> se ha
            sumado a esta tendencia, ya sea ofreciendo productos alimenticios
            orgánicos preparados con los más frescos ingredients, como también
            disponiendo de productos no alimenticios fabricados con materiales
            reciclados.
          </div>
